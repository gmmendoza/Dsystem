...
export default function Planificador() {
  ...
  return (
    <div className="min-h-screen pb-32 max-w-[1400px] mx-auto px-6 animate-in fade-in duration-700">
      ...
      {/* ── NOTION STYLE HEADER ── */}
      <div className="sticky top-0 z-50 bg-surface/40 backdrop-blur-2xl border-b border-white/5 -mx-6 px-6 py-5 mb-12 flex items-center justify-between">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
        ...
        <div className="lg:col-span-8 space-y-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
                 ...
                 <div className="flex items-center gap-6 pt-4">
                    <div className="flex-1 space-y-2">
                       ...
                       <select 
                         className="w-full bg-surface-subtle border border-white/5 rounded-xl px-4 py-3 text-[10px] font-black uppercase tracking-widest outline-none focus:border-indigo-500/40"
                         style={{ color: 'rgb(var(--color-text))' }}
           ...
           <section className="space-y-8 pt-10">
              ...
              <textarea 
                 className="w-full bg-surface-subtle border border-white/5 rounded-[2.5rem] p-10 text-xs text-gray-400 outline-none focus:border-indigo-500/40 transition-all font-medium min-h-[160px] resize-none leading-relaxed focus:bg-surface-muted"
                 style={{ color: 'rgb(var(--color-text))' }}
        ...
        <div className="lg:col-span-4 lg:block hidden">
           <div className="sticky top-32 space-y-10">
              ...
              <div className="bg-surface-subtle border border-white/10 rounded-[3rem] shadow-2xl overflow-hidden flex flex-col min-h-[650px] group/doc">
